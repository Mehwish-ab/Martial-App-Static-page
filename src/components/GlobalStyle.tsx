...
export const linearGradientBtns =
    'linear-gradient(270.24deg, #C0E9F9 0.21%, #A2DDF3 97.73%)'
...
export const ProfileImage = styled.div<profileImgeProps>`
    ...
    background-repeat: ${(props) =>
        props.repeat ? props.repeat : 'no-repeat'};
    background-size: ${(props) => (props.size ? props.size : 'cover')};
    background-position: ${(props) =>
        props.postion ? props.postion : 'center'};
    transition: all 1s ease-in-out;
