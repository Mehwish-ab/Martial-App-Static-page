    ...
    return (
        <CurrencyStyling>
            <div className="curreny">
                ...
                <p className="curreny-text mt-20">
                    When applicable, prices will be converted to and shown in
                    the currency that you select. The currency you pay in may
                    differ based on your reservation, and a service fee may also
                    apply.
                </p>
                    ...
                    <Col md="3">
                        <div className="card-mainContainer d-flex align-items-center justify-content-between ">
                            <div>
                                ...
                                <p className="curreny-text m-0 text-uppercase">
                                    EUR
                                </p>
                            </div>
                            <img
