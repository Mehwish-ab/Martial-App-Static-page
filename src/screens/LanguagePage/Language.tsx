            ...
            <div className="language">
                ...
                <Row>
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3">
                            <img src={UK_Flag} alt="UK" width={26} height={16} />
                    ...
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3">
                            <img src={UK_Flag} alt="UK" width={26} height={16} />
                            <p className="language-text m-0">Brazilian Jiu Jitsu</p>
                        </div>
                    </Col>
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3">
                ...
                <Row>
                    ...
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3 mb-20">
                            <img src={UK_Flag} alt="UK" width={26} height={16} />
                            <p className="language-text m-0">Functional Training</p>
                        </div>
                    </Col>
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3 mb-20">
                            <img src={UK_Flag} alt="UK" width={26} height={16} />
                            <p className="language-text m-0">Ginastica Natural</p>
                        </div>
                    </Col>
                    <Col md="3">
                        <div className="d-flex align-items-center column-gap-3 mb-20">
