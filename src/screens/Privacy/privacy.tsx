    ...
    return (
        <>
            ...
            <PrivacyStyling>
                ...
                <p className="mt-20">
                    The words with capitalized initials have meanings defined
                    under the following conditions. The following definitions
                    apply whether they appear in singular or plural.
                </p>
                ...
                <ul>
                    <li>
                        <p>
                            <span>Affiliate </span>means an entity that
                    ...
                    <li>
                        <p>
                            ...
                            Company,We,Us,orOur in this Agreement) refers to
                            Martial App Ltd, ac.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <span>Terms and Conditions </span>(also referred to
                            ...
                            Conditions agreement has been created with the help
                            of the Terms and Conditions Generator.
                        </p>
                    </li>
                    <li>
                        <p>
                            <span>Third-party Social Media Service </span>means
                    ...
                    <li>
                        <p>
                            <span>Website </span> refers to Martial App,
                            accessible from{' '}
                            <Link to={''}>https://martialapp.com/.</Link>
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <p className="mt-10">
                    ...
                    Service. You represent that you are over the age of 18. The
                ...
                <p className="mt-10">
                    ...
                    conditions and privacy policies of any third-party websites
                ...
                <p className="mt-10">
                    ...
                    by You through the Service or 100 USD if You havent
                    purchased anything through the Service. To the maximum
                    ...
                    limitations may not apply. In these states, each partys
                ...
                <p className="mt-10">
                    ...
                    or defects can or will be corrected. Without limiting the
                    foregoing, neither the Company nor any of the companys
                    provider makes any representation or warranty of any kind,
                    express or implied: (i) as to the operation or availability
                    of the Service, or the information, content, and materials
                    ...
                    worms, malware, time bombs or other harmful components. Some
                ...
                <p className="mt-10">
                    ...
                    shall not affect a partys ability to exercise such right or
                ...
                <ul>
                    <li>
                        <p>
                            By email: <u>support@martialapp.com</u>
                        </p>
                    </li>
                    <li>
                        <p>
                            By mail: Martial App Ltd, 23 Neptune Court, Brighton
                            Marina Village, Brighton, East Sussex, BN2 5SL.
                        </p>
                    </li>
                </ul>
            </PrivacyStyling>
