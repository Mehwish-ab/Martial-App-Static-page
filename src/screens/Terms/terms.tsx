    ...
    return (
        <TermsStyling>
            ...
            <p className="mt-20">
                ...
                the following conditions. The following definitions apply
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        We, Us, or Our in this Agreement) refers to Martial App
                        Ltd, ac.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        <span>Website </span> refers to Martial App, accessible
                        from <Link to={''}>https://martialapp.com/.</Link>
                    </p>
                </li>
                <li>
                    <p>
            ...
            <p className="mt-10">
                ...
                of Your personal information when You use the Application or the
            ...
            <p className="mt-10">
                ...
                trojan horses, worms, malware, time bombs or other harmful
